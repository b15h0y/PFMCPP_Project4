...
public:  
    ...
    FloatType& pow(float);
    FloatType& apply(std::function<FloatType& (float&)> func = nullptr )
    {
        if (func != nullptr)
        {
            return func(*pt);
...
public: 
    ...
    DoubleType& apply(std::function<DoubleType& (double&)> func = nullptr )
    {
        if (func != nullptr)
        {
            return func(*pt);
...
public: 
    ...
    IntType& pow(int);
    IntType& apply(std::function<IntType& (int&)> func = nullptr )
    {
        if (func != nullptr)
        {
            return func(*pt);
